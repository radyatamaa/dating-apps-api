...
func registerCustomIndonesianTranslator(v *validatorGo.Validate, trans ut.Translator) {
	...
	if err := v.RegisterTranslation("URL", trans, func(ut ut.Translator) error {
		if err := ut.Add("URL", "{0} harus berisi domain valid dan format http atau https", false); err != nil {
			return err
		}
		return nil
	}, func(ut ut.Translator, fe validatorGo.FieldError) string {
	...
	if err := v.RegisterTranslation("email_address", trans, func(ut ut.Translator) error {
		if err := ut.Add("email_address", "Silahkan isi {0} dengan format: example@address.com", false); err != nil {
			return err
		}
		return nil
	}, func(ut ut.Translator, fe validatorGo.FieldError) string {
